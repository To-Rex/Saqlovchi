    ...
    showDialog(
      ...
      builder: (context) => Dialog(
        ...
        child: Container(
          ...
          child: Column(
            children: [
              // Sarlavha va yopish tugmasi (statik)
              Padding(
                      ...
                      child: Obx(() => DropdownButtonFormField<String>(
                        ...
                        items: [
                          DropdownMenuItem(
                            ...
                            child: Text(
                              'Barchasi',
                              style: TextStyle(fontSize: Responsive.getFontSize(context, baseSize: 12)),
                            ),
                          ),
                          DropdownMenuItem(
                            value: 'returned',
                    ...
                    return Obx(() {
                      ...
                      List<dynamic> filteredSales = allSales.where((sale) {
                        final productName = sale['sale_items'] != null &&
                            ...
                            sale['sale_items'][0]['batches'] != null &&
                            sale['sale_items'][0]['batches']['products'] != null
                            ? sale['sale_items'][0]['batches']['products']['name']?.toString().toLowerCase() ?? ''
                            : '';
                        final matchesSearch = searchQuery.value.isEmpty || productName.contains(searchQuery.value);
                        final matchesStatus = selectedStatus.value == 'all' ||
                            (selectedStatus.value == 'returned' && sale['sale_type'] == 'returned') ||
                            (selectedStatus.value == 'debt' &&
                                (sale['sale_type'] == 'debt' || sale['sale_type'] == 'debt_with_discount')) ||
                            (selectedStatus.value == 'discount' &&
                                (sale['sale_type'] == 'discount' || sale['sale_type'] == 'debt_with_discount')) ||
                      ...
                      filteredSales.sort((a, b) {
                        ...
                        return sortOrder.value == 'newest' ? dateB.compareTo(dateA) : dateA.compareTo(dateB);
                      });
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              sale['sale_date'] != null
                                                  ? sale['sale_date'].substring(0, 16) // YYYY-MM-DD HH:MM
                                                  : 'Noma’lum vaqt',
                                              style: TextStyle(
                                                color: Colors.black54,
                                                fontSize: Responsive.getFontSize(context, baseSize: 12),
                                      ...
                                      IconButton(
                                        ...
                                        onPressed: controller.isSelling.value
                                          ...
                                          controller.recentSalesFuture.value =
                                              controller.apiService.getRecentSales(limit: 3); // Ro‘yxatni yangilash
                                        },
                                      ),
                                  ],
                                ),
